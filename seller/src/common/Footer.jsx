...
export default function Footer() {
  ...
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-12 lg:grid-cols-2">
    ...
    <div>
     ...
     <Button variant="outline" className="bg-white text-black py-5 px-8  border border-navyblue cursor-pointer">
            Get Started
          </Button>
    </div>
...
<div className="grid grid-cols-2 sm:grid-cols-2">
  ...
  <div className="border-t border-gray-700 mt-16 pt-6 text-center text-xs text-gray-500">
    © {new Date().getFullYear()} <span className="text-white">Erovians.</span> All rights reserved.
  </div>
</footer>
