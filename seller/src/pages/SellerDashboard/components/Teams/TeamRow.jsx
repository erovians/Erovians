  ...
  return (
    <tr className="align-middle border-b">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-gray-500 text-xs">
              {member.email || "No Email"} - {member.mobile || "No Email"}
            </div>
          </div>
        </div>
      </td>
      ...
      <td className="px-4 py-4 text-sm text-gray-500">
        {timeAgo(member.lastActive || member.updatedAt || member.createdAt)} ago
      </td>
      <td className="px-4 py-4 relative" ref={menuRef}>
        ...
        {menuOpen && (
          <div
            role="menu"
            aria-label="actions"
            className="absolute right-2 mt-2 w-36 bg-white border rounded shadow z-50"
          >
            <button
              onClick={() => {
                setMenuOpen(false);
