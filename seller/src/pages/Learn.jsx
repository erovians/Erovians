...
const Learn = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full mt-10 px-4 py-10 min-h-fit"  id="whatSellerSays">
        {/* Section Heading */}
        ...
        <Accordion type="single" collapsible className="w-full divide-y">
          <AccordionItem value="item-1" className="py-4">
            ...
            <AccordionContent className="text-gray-600 text-sm leading-relaxed">
              Yes, you can sell on Erovians with a Composition GSTIN. However, certain categories may have restrictions
              depending on compliance and GST rules.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2" className="py-4">
            ...
            <AccordionContent className="text-gray-600 text-sm leading-relaxed">
              Yes! Even if you don’t have a GSTIN or have a Composition GSTIN, you can still sell on Erovians. 
              We provide a simple onboarding process for all sellers.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3" className="py-4">
            ...
            <AccordionContent className="text-gray-600 text-sm leading-relaxed">
              To get started, you need a valid bank account, PAN card, and business details. 
              GSTIN is optional for certain categories and sellers under Composition schemes.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4" className="py-4">
            ...
            <AccordionContent className="text-gray-600 text-sm leading-relaxed">
              We provide dedicated seller support, training resources, and easy-to-use tools 
              to help you list products, manage inventory, and reach crores of customers online.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-5" className="py-4">
            ...
            <AccordionContent className="text-gray-600 text-sm leading-relaxed">
              With Erovians, you get access to a large customer base, low commission rates, 
              reliable logistics support, and secure payments—all designed to grow your business faster.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
